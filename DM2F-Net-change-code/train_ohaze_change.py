...
from model_change3 import DM2FNet_woPhy
...
def train(net, optimizer):
    ...
    while curr_iter <= cfgs['iter_num']:
        ...
        loss_x_j3_record, loss_x_j4_record, loss_x_j5_record = AvgMeter(), AvgMeter(), AvgMeter()
        ...
        for data in train_loader:
            ...
            with amp.autocast():
                x_jf, x_j1, x_j2, x_j3, x_j4, x_j5 = net(haze)
                ...
                loss = loss_x_jf + loss_x_j1 + loss_x_j2 + loss_x_j3 + loss_x_j4 + loss_x_j5
            ...
            log = '[time %s], [iter %d], [train loss %.5f], [loss_x_fusion %.5f], [loss_x_j1 %.5f], ' \
                  '[loss_x_j2 %.5f], [loss_x_j3 %.5f], [loss_x_j4 %.5f], [loss_x_j5 %.5f], [lr %.13f]' % \
                  (str(datetime.datetime.now()), curr_iter, train_loss_record.avg, loss_x_jf_record.avg,
                   ...
                   loss_x_j5_record.avg, optimizer.param_groups[1]['lr'])
            #print(log)

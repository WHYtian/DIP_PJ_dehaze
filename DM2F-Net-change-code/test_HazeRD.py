...
def main(args):
    types = ['50', '100', '200', '1000']
    #types = ['50']
    for t in types:
        log_path = os.path.join('/mnt/result_test', args['snapshot']+'_'+t+ '.txt')
        filenames = [file for file in os.listdir('/mnt/data/HazeRD/data/simu') if file.endswith(t+'.jpg')]
        with torch.no_grad():
            ...
            for idx, data in enumerate(dataloader):
                ...
                for i in range(len(fs)):
                    ...
                    ciede2000 = deltaE_ciede2000(gt, r).mean()
...
#     ]
    argss = [
        {
            'snapshot': 'iter_1000_loss_0.02359_lr_0.000002',
        }
    ]
    for args in argss:
        main(args)
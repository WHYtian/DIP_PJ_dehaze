...
# O-Haze
OHAZE_ROOT = osp.abspath(osp.join('/mnt/data', 'O-Haze'))
#OHAZE_ROOT = osp.abspath(osp.join(root, '../data', 'O-Haze'))
# path = ''
# OHAZE_ROOT = 

# RESIDE
TRAIN_ITS_ROOT = osp.abspath(osp.join('/mnt/data', 'RESIDE', 'ITS_v2'))  # ITS
TEST_SOTS_ROOT = osp.abspath(osp.join('/mnt/data', 'RESIDE', 'SOTS', 'nyuhaze500'))  # SOTS indoor
